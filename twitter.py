...
loc = '1.290270, 103.851959, 20km' #SG coordinates
testlib = itertools.islice(sntwitter.TwitterSearchScraper(' geocode:"{}" lang:en min_retweets:5 min_faves:5'.format(loc)).get_items(),100)
df_test = []
for i in testlib:
